(ns fmuit.crux.scratch
  (:require [crux.api :as crux]
            [fmuit.crux.easy :as gce]
            [fmuit.crux.user :as user]
...
(comment
  ...
  (fmuit.crux.user/create node {:user/name "a" :user/email "a@a.com" :user/password-hash "qwe"})
  (fmuit.crux.user/create node {:user/name "placeholder1" :user/email "placeholder1@placeholder.com" :user/password-hash "qwe"})
  (fmuit.crux.user/create node {:user/name "placeholder2" :user/email "placeholder2@placeholder.com" :user/password-hash "qwe"})
  (fmuit.crux.user/create node {:user/name "placeholder3" :user/email "placeholder3@placeholder.com" :user/password-hash "qwe"})
  (fmuit.crux.user/create node {:user/name "placeholder4" :user/email "placeholder4@placeholder.com" :user/password-hash "qwe"})
  (fmuit.crux.user/create node {:user/name "placeholder5" :user/email "placeholder5@placeholder.com" :user/password-hash "qwe"})
  (fmuit.crux.user/create node {:user/name "placeholder6" :user/email "placeholder6@placeholder.com" :user/password-hash "qwe"})
  ...
  (gce/install-tx-fns node '[fmuit.crux.user])
  ...
  (install-tx-fns node '[fmuit.crux.scratch])
