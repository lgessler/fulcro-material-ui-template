(ns fmuit.client.ui.admin-settings.project-management
  (:require [com.fulcrologic.fulcro.components :as c :refer [defsc]]
            ...
            [fmuit.models.project :as project :refer [validator]]
...
(defsc AddProject [this {:project/keys [id name] :ui/keys [busy?] :as props}]
  {:ident                   :project/id
   ...
   :validator               validator
   ::forms/create-mutation  'fmuit.models.project/create-project
