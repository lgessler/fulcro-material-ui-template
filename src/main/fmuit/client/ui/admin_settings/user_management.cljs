(ns fmuit.client.ui.admin-settings.user-management
  (:require [com.fulcrologic.fulcro.components :as c :refer [defsc]]
            ...
            [fmuit.models.user :as user :refer [validator]]
...
(defsc UserAccordion [this
  ...
  {:query                   [:user/id :user/name :user/email :user/new-password :user/admin?
   ...
   :validator               validator
   ::forms/save-mutation    'fmuit.models.user/save-user
   ::forms/save-message     "User saved"
   ::forms/save-extra-props [:user/new-password]
   ::forms/delete-mutation  'fmuit.models.user/delete-user
...
(defsc AddUser [this {:user/keys [id name email password admin?] :ui/keys [busy?] :as props}]
  {:ident                   :user/id
   ...
   :validator               validator
   ::forms/create-mutation  'fmuit.models.user/create-user
